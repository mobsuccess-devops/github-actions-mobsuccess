...
describe("genaiDetection", () => {
  ...
  describe("hasRapidCommits", () => {
    ...
    test("should detect rapid commits (4+ commits with 3+ rapid pairs within 15 seconds)", () => {
      const commits = [
        makeCommit("abc1234", "2024-01-01T10:00:00Z"),
        makeCommit("def5678", "2024-01-01T10:00:05Z"), // 5 sec later
        makeCommit("ghi9012", "2024-01-01T10:00:10Z"), // 5 sec later
        makeCommit("jkl3456", "2024-01-01T10:00:15Z"), // 5 sec later (3 rapid pairs total)
      ];
      const result = hasRapidCommits(commits);
      expect(result.detected).toBe(true);
      expect(result.details).toContain("within 15 seconds");
    });
        ...
        if (endpoint.includes("commits")) {
          return Promise.resolve([
            ...
            },
            {
              ...
              commit: {
                message: "fix: typo",
                author: { date: "2024-01-01T10:00:05Z" },
              },
              author: { login: "johndoe" },
              committer: { login: "johndoe" },
            },
            ...
            },
            {
              ...
              commit: {
                ...
                author: { date: "2024-01-01T10:00:15Z" },
              },
              author: { login: "johndoe" },
              committer: { login: "johndoe" },
            },
