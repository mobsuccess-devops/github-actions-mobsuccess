...
describe("genaiDetection", () => {
  describe("isGenAIBot", () => {
    test.each(["copilot[bot]"])("should detect GenAI bot: %s", (author) => {
  ...
  describe("isAutomationBot", () => {
    ...
    test.each([
      ...
      "johndoe",
      "alice",
    ])("should NOT detect as automation bot: %s", (author) => {
  ...
  describe("hasRapidCommits", () => {
    ...
    test("should detect rapid commits (3+ within 30 seconds)", () => {
      ...
      expect(result.details).toContain("3 commits within 30 seconds");
    });
