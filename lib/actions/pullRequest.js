...
exports.validatePR = async function validatePR({ pullRequest, issue }) {
  ...
  if (pullRequest) {
    ...
    // feature/cypress-lco => active / ajout de cypress
    // feature/cypress-lco-markers => merged / ajout de markers cypress
    // feature/lco-data-cy-markers
    ...
    if (!oneBranchIsOk && nokBranch) {
      throw new Error(
        `This pull request is based on the branch “${headRef}”, which starts like “${nokBranch}”. Use double dashes (“--”) to separate sub-branches. See https://www.notion.so/mobsuccess/Git-Guidelines-41996ef576cb4f29b7737772b74289c5?pvs=4#f9cadc10d949498dbe38c0eed08fd4f8`
      );
    }
