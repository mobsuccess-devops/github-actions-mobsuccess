...
// that may need multiple signals to be confident. Enable them when implementing
// a multi-flag scoring system (e.g., label only if 2+ flags are detected).
const DEFAULT_OPTIONS = {
  detectRapidCommits: false, // TODO: Enable as part of multi-flag scoring system
  detectCommentPatterns: false, // TODO: Enable as part of multi-flag scoring system
};
